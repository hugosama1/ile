...
/*
    ...
    loadExcercise: function() {
        ...
        if( ejercicio) {
            $.getJSON( "js/ejercicio"+ejercicio+".json", function( data, textStatus, jqxhr ) {
                ...
                $.post( "/laravelile/public/api/last_exercise",  {user_id:Interface.userID ,exercise_id:Interface.exercise_id},function(data) {
    ...
    setCarouselHeight : function(id)
    {
        ...
        switch(id) {
            case 'login': 
                $.post( "/laravelile/public/api/login",  { "id": Interface.userID,"email": Interface.userEmail });
                break;
            case 'excercise':
                $.post( "/laravelile/public/api/save_exercise",  {user_id:Interface.userID ,exercise_id:Interface.exercise_id,correct:true,step_number:Interface.excerciseNumber});
                break;
            break;
        }
    },
