       	...
       	<main>
	        ...
	        <section id="slide-1" class="homeSlide">
	        	<div class="bcg" data-center="background-position: 50% 0px;" data-top-bottom="background-position: 50% -100px;" data-anchor-target="#slide-1">
		        	<div class="hsContainer">
			    		<div class="hsContent bgBlack" data-center="opacity: 1" data-106-top="opacity: 0" data-anchor-target="#slide-1 h2" >
				    		<h2 >Web Based Intelligent<br /> Learning Enviroment</h2>
				    		<p>Enseñanza de compiladores con metodolog&iacute;a apprenticeship</p>
			    		</div>
		        	</div>
	        	</div>
		    </section>
		    ...
		    <section id="slide-2">
		    	<div class="bcg" data-0="background-color:rgb(1,27,59);" data-top="background-color:(0,0,0);"  data-anchor-target="#slide-2">
			    	<div class="hsContainer">
			    		<div class="hsContent">
				    		<h2 data-center="opacity: 1" data--200-bottom="opacity: 0" data-206-top="opacity: 1" data-106-top="opacity: 0" data-anchor-target="#slide-2 h2">Mini Java</h2>
				    		<p data-center="opacity: 1" data--200-bottom="opacity: 0" data-206-top="opacity: 1" data-106-top="opacity: 0" data-anchor-target="#slide-2 h2">Se crea un compilador basado en un subconjunto del conocido e inigualable java, el cual permite el aprendizaje r&aacute;pido y efic&aacute;z</p>
			    		</div>
		        	</div>
		    	</div>
		    </section>
    	...
    	<div class="hsContainer">
    		<div class="hsContent">
    			<div class="plaxEl" data-106-top="opacity: 0" data--30p-top="opacity: 1;" data--60p-top="opacity: 0;" data-bottom="opacity: 1; position: fixed; top: 206px; width: 100%; left: 0;"  data-anchor-target="#slide-3">
		    		...
		    		<p><span class="bgBlack">Utiliza lo &uacute;ltimo en t&eacute;cnicas de detecci&oacute; de emociones y respuestas basadas en evidencias.</span></p>
	    		</div>
    		</div>
    	</div>
		...
		<section id="slide-4" class="homeSlide homeSlideTall">
			<div class="bcg" data-center="background-position: 50% 0px;" data-bottom-top="background-position: 50% 100px;" data-top-bottom="background-position: 50% -100px;" data-anchor-target="#slide-4">
				<div class="curtainContainer">
					...
					<div class="copy" data-bottom-top="opacity: 0" data--100-bottom="opacity: 0" data--280-bottom="opacity: 1;" data-280-top="opacity: 1;" data-106-top="opacity: 0;" data-anchor-target="#slide-4 .copy">
						<h2>Incluye el conocimiento de expertos con 20 años de experiencia</h2>
					</div>
		    ...
		    <section id="slide-5" class="homeSlide homeSlideTall2">
		    	...
		    	<div class="bcg bcg2" data-bottom-top="opacity: 0;" data--33p-top="opacity: 0;" data--66p-top="opacity: 1;" data-anchor-target="#slide-5">
			    	<div class="hsContainer">
				    	<div class="hsContent bgBlack" data-bottom-top="opacity: 0;" data-center="opacity: 1" data-anchor-target="#slide-5">
				    		<h2>Personalizado para ti</h2>
				    		<p>El ambiente se adapta en base a los aciertos y errores cometidos por el usuario.</p>
			    		</div>
			    	</div>
		    	</div>
		    </section>
